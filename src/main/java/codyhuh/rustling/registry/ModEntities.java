...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<Rustling>> RUSTLING = ENTITIES.register("rustling",
            () -> EntityType.Builder.of(Rustling::new, MobCategory.CREATURE).sized(0.625F, 1.2F).build("rustling"));

    public static final RegistryObject<EntityType<RustMuncherEntity>> RUSTMUNCHER = ENTITIES.register("rustmuncher",
